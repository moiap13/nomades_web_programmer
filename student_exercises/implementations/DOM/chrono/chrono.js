...
time.minutes = 10
time.secondes = 12
time.millisecondes = 12

console.log(`${time.minutes}:${time.secondes}:${time.millisecondes}`)
document.querySelector("#ecran").textContent = `${time.minutes}:${time.secondes}:${time.millisecondes}` 